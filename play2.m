function varargout = play2(varargin)
% PLAY2 MATLAB code for play2.fig
%      PLAY2, by itself, creates a new PLAY2 or raises the existing
%      singleton*.
%
%      H = PLAY2 returns the handle to a new PLAY2 or the handle to
%      the existing singleton*.
%
%      PLAY2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PLAY2.M with the given input arguments.
%
%      PLAY2('Property','Value',...) creates a new PLAY2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before play2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to play2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help play2

% Last Modified by GUIDE v2.5 09-Jul-2017 23:02:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @play2_OpeningFcn, ...
                   'gui_OutputFcn',  @play2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before play2 is made visible.
function play2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to play2 (see VARARGIN)

% Choose default command line output for play2
...
% UIWAIT makes play2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = play2_OutputFcn(hObject, eventdata, handles) 
...
function box_CreateFcn(hObject, ~, handles)
% hObject    handle to box (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
if pl1 == 1
    ...
    elseif pl2 == 2
        ...
        hold on
        wp1=insertText(wp,[60 500], strcat(p1name,s2),'FontSize',100,'BoxColor','red', ...
    ...
    elseif pl2 == 3
        ...
        wp=imread('winner.jpg');
        hold on
        wp1=insertText(wp,[60 500], strcat(p2name,s2),'FontSize',100,'BoxColor','red', ...
            'BoxOpacity',0.6,'TextColor','white');
        figure,imshow(wp1)
        hold off
    end
